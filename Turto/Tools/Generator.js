...
function Generator() {
    ...
    function renderBlogsListContent(items, pageNum, currentPageIndex) {
        ...
        return ejs.render(tmplStr, { renderItems: items, currentPageIndex: currentPageIndex, pageNum: pageNum });
    }
